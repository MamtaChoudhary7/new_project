...
$sql="select Branch from user where RollNo='$rollno'";
...
if($category == 'CSE' || $category == 'ECE' || $category == 'MECH' || $category == 'EEE' )
{
$sql1="update record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 60 day),Renewals_left=1,Returns_left=1 where BookId='$bookid' and RollNo='$rollno'";
...
{$sql2="update record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 180 day),Renewals_left=1,Returns_left=1 where BookId='$bookid' and RollNo='$rollno'";
