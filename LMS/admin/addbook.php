                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="price" name="price" placeholder="price" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="edition"><b>Edition</b></label>
                                            <div class="controls">
                                                <input type="text" id="edition" name="edition" placeholder="edition" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="rackno"><b>Rack No</b></label>
                                            <div class="controls">
                                                <input type="text" id="rackno" name="rackno" placeholder="Rack no" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
if(isset($_POST['submit']))
{
    ...
    $total=$_POST['availability'];

$sql1="insert into book (Title,Publisher,Year,Availability,totalbooks) values ('$title','$price','$publisher','$edition','$year','$availability','$total')";
