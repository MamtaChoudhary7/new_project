                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select record.BookId,RollNo,`book`.`Title`,Due_Date,Date_of_Issue,datediff(curdate(),Due_Date) as x from record,book where (Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId) and (RollNo='$s' or record.BookId='$s' or `book`.`Title` like '%$s%')";
                                        }
                                    else
