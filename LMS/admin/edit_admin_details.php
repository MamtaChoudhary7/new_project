...
if(! isset($_SESSION["teacherId"]) ){
    session_start();
header("location:edit_admin_details.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                $rollno = $_SESSION['teacherId'];
                                $sql="select * from teacher where teacherId='$rollno'";
...
$sql1="update teacher set Name='$name', EmailId='$email', MobNo='$mobno', Password='$pswd' where teacherId='$teacherId'";
