                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select `return`.`BookId`,`book`.`Title`,`return`.`RollNo`,datediff(curdate(),Due_Date) as x from `record`,`book`,`return` where `return`.BookId=`book`.BookId and `return`.RollNo=`record`.RollNo and `return`.`BookId`=`record`.`BookId` and `return`.`BookId`=`book`.`BookId`";
